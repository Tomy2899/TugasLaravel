            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('template')}}/dist/img/tomy.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">Tomy Haryanto</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-heade r">
                    <img src="{{asset('template')}}/dist/img/tomy.png" class="img-circle" alt="User Image">
                    <p>
                      Tomy Haryanto - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="{{asset('template')}}/dist/tomy.png" class="img-circle" alt="User Image">
            </div>
